 ...
 * @subpackage Elegant_Form/public
 */
...
class Elegant_Form_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name.'-dropzone-css', plugin_dir_url( __FILE__ ) . 'css/dropzone.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script($this->plugin_name.'-dropzone-js', plugin_dir_url(__FILE__) . 'js/dropzone.js', array(), $this->version, false);
